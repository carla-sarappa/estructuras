...
*/
{
    ...
    if (not isNil(xs)) {
        ...
        return currMax;
    } else {BOOM("La lista vacia no tiene maximo.\n"); }
}
...
*/
{
    ...
    if (isNil(xs)) BOOM("La lista vacia no tiene maximo.\n")
    else {
        y = head(xs);
        ys = tail(xs);
...
void testingLists(ListInt xs) {
    ...
    printf("\n");
    printf("\n");
    printf("zipAdd(xs,Cons(0,xs))           = ");
    printList(zipAdd(xs, Cons(0, xs)));
    printf("\n");
    printf("sePuedeExpandirA(ipares(xs),xs) = ");
    printBool(sePuedeExpandirA(ipares(xs), xs));
    printf("\n");
    printf("inub(xs)                        = ");
    printList(inub(xs));
    printf("\n");
    printf("iposPares(xs)                   = ");
    printList(iposPares(xs));
    printf("\n");
    printf("verifSumAnteriores(xs)          = ");
    printBool(verifSumAnteriores(xs));
    printf("\n");
    printf("verifOrdenada(xs)               = ");
    printBool(verifOrdenada(xs));
    printf("\n");
    printf("\n");

    ListInt ys = iappend(xs, ipares(xs));
    printf("ys=append(xs,pares(xs)) = ");
    printList(ys);
    printf("\n");
    printf("ilength(ys)             = %d\n", ilength(ys));
    ...
    printf("\n");
    printf("\n");
    printf("zipAdd(ys,Cons(0,ys))           = ");
    printList(zipAdd(ys, Cons(0, ys)));
    printf("\n");
    printf("sePuedeExpandirA(ipares(ys),ys) = ");
    printBool(sePuedeExpandirA(ipares(ys), ys));
    printf("\n");
    printf("nub(ys)                         = ");
    printList(inub(ys));
    printf("\n");
    printf("iposPares(ys)                   = ");
    printList(iposPares(ys));
    printf("\n");
    printf("verifSumAnteriores(ys)          = ");
    printBool(verifSumAnteriores(ys));
    printf("\n");
    printf("verifOrdenada(ys)               = ");
    printBool(verifOrdenada(ys));
    printf("\n");
    printf("\n");
