...
void testingLists(ListInt xs) {
    ...
    cout << ("\n");
    cout << ("\n");
    cout << ("zipAdd(xs,Cons(0,xs))           = ");
    printList(zipAdd(xs, Cons(0, xs)));
    cout << ("\n");
    cout << ("sePuedeExpandirA(ipares(xs),xs) = ");
    ...
    cout << ("\n");
    cout << ("\n");
    cout << ("zipAdd(ys,Cons(0,ys))           = ");
    printList(zipAdd(ys, Cons(0, ys)));
    cout << ("\n");
    cout << ("sePuedeExpandirA(ipares(ys),ys) = ");
    ...
    cout << ("\n");
    cout << ("verifSumAnteriores(ys)          = ");
    printBool(verifSumAnteriores(ys));
    cout << ("\n");
    cout << ("verifOrdenada(ys)               = ");
